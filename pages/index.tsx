    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{ transform: `translateY(-${currentSectionIndex * 100}dvh)` }}
        >

          {/* Screen 1: Identity */}
          <section id="identity" className="h-[100dvh] w-full flex flex-col items-start justify-center p-6 md:pl-32 relative z-10 overflow-hidden">
          ...
          {/* Screen 2: Education */}
          <section id="education" className="h-[100dvh] w-full flex flex-col items-start justify-center p-6 md:pl-32 relative z-10 overflow-hidden">
          ...
          {/* Screen 3: Skills */}
          <section id="skills" className="h-[100dvh] w-full flex flex-col items-start justify-center p-6 md:pl-32 relative z-10 overflow-hidden">
            {/* 3D Object: Cube on Right for Others */}
            <div className="absolute right-20 top-1/2 -translate-y-1/2 hidden md:block pointer-events-none opacity-40">
              <RotatingCube />
            </div>
          ...
          {/* Screen 4: Projects */}
          <section id="projects" className="h-[100dvh] w-full flex flex-col items-start justify-center p-6 md:pl-32 relative z-10 overflow-hidden">
            {/* 3D Object: Cube on Right for Others */}
            <div className="absolute right-20 top-1/2 -translate-y-1/2 hidden md:block pointer-events-none opacity-40">
              <RotatingCube />
            </div>
          ...
          {/* Screen 5: Connect */}
          <section id="connect" className="h-[100dvh] w-full flex flex-col items-start justify-center p-6 md:pl-32 relative z-10 overflow-hidden">
            {/* 3D Object: Cube on Right for Others */}
            <div className="absolute right-20 top-1/2 -translate-y-1/2 hidden md:block pointer-events-none opacity-40">
              <RotatingCube />
            </div>
